...
const routes: Routes = [
  ...
  {path : 'hc/:idHistoriaClinica', component: HistoriaClinica, canActivate : [AuthGuard], canDeactivate: [ConfirmarSalidaGuard]},  {path : 'hc', component: HistoriaClinica, canActivate : [AuthGuard], canDeactivate: [ConfirmarSalidaGuard]},
